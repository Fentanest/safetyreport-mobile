...
## 기본 명령
```sh
flutter analyze            # 2026-09-24 시범 후: error 0 / warning 2(기존) / info 65 → 종료코드 1 (시작 baseline: info 73)
flutter test               # 2026-09-24 시범 후: 전체 통과 (골든은 `golden` 태그, 폰트 없는 환경에서 자동 skip)
```
