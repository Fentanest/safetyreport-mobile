# legacy CLAUDE.md 원문 보관본

> 2026-09-24 문서 체계화 직전의 루트 `CLAUDE.md` 원문(sha256 `32e8f475b492e8b5a8b1db131f250486d8175fd4b8728062ca2fede28c079481`,
> 마지막 변경 커밋 `161b68dc8cf4cdfacbeb15fa580839a011f0b163`, 작업 base HEAD `c64be69a`).
> **자동 import 대상이 아니다.** 참고/대조용으로만 읽는다. 현행 정보는 `docs/architecture/*.md` 를 본다.
