...
상태: **S-01~S-09 결정·구현 완료(2026-09-24)**, S-10 신규 발견(결정 필요). 작성 2026-09-24, base `c64be69a`.
...
| S-10 | **신규 발견, 미변경**: 서버 `/stats` 는 담당자 없음+진행중 행을 기관별 집계에서도 빼고 NULL 기관을 '알수없음'으로 묶지만, Standalone 은 담당자별에서만 빼고 빈 기관 행은 건너뛴다 → 모드 간 기관표 건수가 조금 다를 수 있다. 결정 필요 |
