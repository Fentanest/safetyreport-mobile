...
class Report {
  ...
  /// nullable 필드를 null 로 바꾸려면 [clearRating] 처럼 명시한다.
  Report copyWith({
    String? id,
    String? reportNumber,
    String? name,
    ...
    int? supplementCount,
    bool? supplementOpen,
    String? supplementRequester,
    String? supplementRequestedAt,
    ...
    return Report(
      ...
      fineInfo: fineInfo ?? this.fineInfo,
      ...
      processingFinish: processingFinish ?? this.processingFinish,
      ...
      supplementOpen: supplementOpen ?? this.supplementOpen,
      supplementRequester: supplementRequester ?? this.supplementRequester,
      supplementRequestedAt:
          supplementRequestedAt ?? this.supplementRequestedAt,
      supplementCompletedAt:
