...
void main() {
  ...
  for (final version in [10, 9]) {
    test(
      'v$version database upgrades to the contract version and keeps existing values',
      () async {
        ...
        final oldCols = (await raw.rawQuery(
        ...
        expect(
          await db.getVersion(),
          (contract['schema_version'] as Map)['mobile'],
        );
